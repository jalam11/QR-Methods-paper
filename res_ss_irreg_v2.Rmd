...
a <- data_hist_50 %>% 
  ...
  ggplot() +
  geom_histogram(aes(x=beta), bins = 40, color="black", fill="white") +
...
hist_50 <- annotate_figure(hist_50, 
                          top = text_grob("Joshua Alampi, Figure 1. This is the top of the figure",
                                             size = 9))

ggsave(file = paste0("sim study/results/figure 1.tiff"), 
       width = 7.5, height = 5, dpi = 800)
